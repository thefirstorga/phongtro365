...
//                 <div className='bg-black p-8 grid gap-4 w-full h-full'>
//                     <div>
...
//                         <div>
//                             <img src={'http://localhost:4000/post/uploads/'+photo.url} alt="" />
//                         </div>
//                     ))}
//                 </div>
//             </div>
...
//                 {place.photos?.[0] && (
//                     <div>
//                         <img onClick={() => setShowAllPhotos(true)} className='aspect-square cursor-pointer object-cover' src={'http://localhost:4000/post/uploads/'+place.photos[0].url} alt="" />
//                     </div>
//                 )}
//             </div>
//             <div className='grid'>
//                 {place.photos?.[1] && (
//                     <img onClick={() => setShowAllPhotos(true)} className='aspect-square cursor-pointer object-cover' src={'http://localhost:4000/post/uploads/'+place.photos[1].url} alt="" />
//                 )}
//                 <div className='overflow-hidden'>
//                     {place.photos?.[2] && (
//                         <img onClick={() => setShowAllPhotos(true)} className='aspect-square cursor-pointer object-cover relative top-2' src={'http://localhost:4000/post/uploads/'+place.photos[2].url} alt="" />
//                     )}
//                 </div>
//             </div>
//         </div>
...
function PlaceGallery({ place }) {
    ...
    if (showImagePopup) {
        return (
            <div className="fixed inset-0 bg-black bg-opacity-50 w-full h-full flex items-center justify-center" onClick={() => setShowImagePopup(false)}>
